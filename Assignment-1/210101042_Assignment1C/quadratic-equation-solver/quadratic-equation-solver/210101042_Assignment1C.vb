...
Public Class qesolver
    ...
    'Dim player As New SoundPlayer("C:\Users\Gautam\Desktop\quadratic-equation-solver\quadratic-equation-solver\Resources\sound-file.mp3")
    Dim relativePath As String = "sound-file.wav" ' Relative path to your sound file
    ...
    Private Sub btn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btn.Click
        'player.Play()
        'My.Computer.Audio.Play("sound-file.wav")
        ...
        If File.Exists(fullPath) Then
            Dim player As New System.Media.SoundPlayer(fullPath)
            player.PlayLooping()
        Else
        ...
        graph.ChartAreas(0).AxisX.Title = "x"

        ' Set the title for the Y-axis
        graph.ChartAreas(0).AxisY.Title = "ax^2 + bx + c"

        ' Set chart area properties to display a coordinate system
        ' Disable automatic axis scale
        graph.ChartAreas(0).AxisX.IsStartedFromZero = False
        graph.ChartAreas(0).AxisY.IsStartedFromZero = False
